  ...
  Widget build(BuildContext context) {
    final logo = Hero(
      ...
      child: CircleAvatar(
        ...
        radius: 48.0, //半径
        child: Image.network(
            "https://t7.baidu.com/it/u=1297102096,3476971300&fm=193&f=GIF"), //图片
      ),
    );
    ...
    final email = TextFormField(
      ...
      initialValue: '123', //默认输入的类容
      decoration: InputDecoration(
          hintText: '请输入用户名', //提示内容
          contentPadding:
              EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0), //上下左右边距设置
    ...
    final loginButton = Padding(
      ...
      child: Material(
        ...
        child: MaterialButton(
          ...
          height: 42.0,
          onPressed: () {
            Navigator.of(context).pushNamed(home_page.tag); //点击跳转界面
          },
